# Welcome to the Najma project

## Amadeus Booking Automation

This project will include a server endpoint at `api/amadeus-booking.js` to automate booking enrichment with Amadeus flight offers or other similar api.
